...
export default class primeraseccion extends Component {
    render() {
        return (
            <section id="home">
                <nav className="navbar navbar-expand-lg" id="navSection">
                    <div className="container-fluid" id="divNavSection">
                        <a className="navbar-brand" img='D:\laragon\www\pinuno\resources\views\images\top-logo.png' id="nav-logo"></a>
                    </div>
